...
import { RiPlayListLine, RiGlobalLine, RiLock2Line } from "react-icons/ri"; // Thêm icon
...
export default function PlaylistDetail() {
        ...
        if (playlistData.songs) {
          playlistData.songs = playlistData.songs.map(song => {
            ...
            return {
              ...song,
              cover_url: coverUrl,
              duration: parseInt(song.duration || 0, 10) // Ép kiểu số để tránh lỗi
            };
          });
        }
  ...
  const getTotalDuration = () => {
    if (!playlist?.songs) return "0 phút";
        ...
        <div className="playlist-banner-content">
          ...
          <div className="playlist-header-info">
            ...
            <span className="playlist-badge">
              {playlist.is_public ? (
                <><RiGlobalLine size={16} /> Public Playlist</>
              ) : (
                <><RiLock2Line size={16} /> Private Playlist</>
              )}
            </span>
